class FloatingButton {
    ...
    async fetchChatUserId(userToken, udid = "") {
        ...
        console.log('this.chatUserId', this.userToken, this.userToken.includes('guest'));
        const params = {
            externalKey: String(this.partnerId),
            userToken: convertedUserToken,
            udid: String(udid),
            chatUserId: this.chatUserId && !this.userToken.includes('guest') ? String(this.chatUserId) : null
        }
